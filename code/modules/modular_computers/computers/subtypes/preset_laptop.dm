...
/obj/item/modular_computer/laptop/preset/custom_loadout/cheap/install_default_hardware()
	..()
	hardware["processor_unit"] = new/obj/item/computer_hardware/processor_unit/small(src)
...
/obj/item/modular_computer/laptop/preset/custom_loadout/advanced/install_default_hardware()
	..()
	hardware["processor_unit"] = new/obj/item/computer_hardware/processor_unit(src)
	hardware["tesla_link"] = new/obj/item/computer_hardware/tesla_link(src) //Only the advanced laptop gets a tesla link
	hardware["hard_drive"] = new/obj/item/computer_hardware/hard_drive/advanced(src)
	hardware["network_card"] = new/obj/item/computer_hardware/network_card/advanced(src)
	hardware["printer"] = new/obj/item/computer_hardware/printer(src)
	hardware["card_slot"] = new/obj/item/computer_hardware/card_slot(src)
...
/obj/item/modular_computer/laptop/preset/debug/install_default_hardware()
	..()
	hardware["printer"] = new/obj/item/computer_hardware/printer(src)
	hardware["processor_unit"] = new/obj/item/computer_hardware/processor_unit/super/small(src)
	hardware["tesla_link"] = new/obj/item/computer_hardware/tesla_link(src)
	hardware["hard_drive"] = new/obj/item/computer_hardware/hard_drive/cluster(src)
	hardware["network_card"] = new/obj/item/computer_hardware/network_card/advanced(src)
	hardware["scanner"] = new /obj/item/computer_hardware/scanner/paper(src)
	hardware["card_slot"] = new/obj/item/computer_hardware/card_slot(src)
