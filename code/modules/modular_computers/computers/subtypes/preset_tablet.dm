...
/obj/item/modular_computer/tablet/preset/custom_loadout/cheap/install_default_hardware()
	...
	hardware["hard_drive"] = new/obj/item/computer_hardware/hard_drive/micro(src)
...
/obj/item/modular_computer/tablet/preset/custom_loadout/advanced/install_default_hardware()
	...
	hardware["processor_unit"] = new/obj/item/computer_hardware/processor_unit/small(src)
	hardware["tesla_link"] = new/obj/item/computer_hardware/tesla_link(src)
	hardware["hard_drive"] = new/obj/item/computer_hardware/hard_drive/small(src)
...
/obj/item/modular_computer/tablet/lease/preset/command/install_default_hardware()
	...
	hardware["printer"] = new/obj/item/computer_hardware/printer(src)
	hardware["card_slot"] = new/obj/item/computer_hardware/card_slot(src)
	hardware["cell"] = new/obj/item/cell/small(src)
...
/obj/item/modular_computer/tablet/moebius/preset/install_default_hardware()
	...
	hardware["hard_drive"] = new/obj/item/computer_hardware/hard_drive(src)
	hardware["network_card"] = new/obj/item/computer_hardware/network_card(src)
	hardware["cell"] = new /obj/item/cell/small/moebius/high(src)
	hardware["scanner"] = new /obj/item/computer_hardware/scanner/medical(src)
	hardware["gps_sensor"] = new /obj/item/computer_hardware/gps_sensor(src)
